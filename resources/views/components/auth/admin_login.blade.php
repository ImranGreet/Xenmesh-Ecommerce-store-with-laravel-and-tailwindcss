...
<section class="w-full h-96 flex flex-col justify-center items-center ">
    <form action="{{route('adminlogin')}}" method="post" class="border-2 rounded-lg shadow-lg flex flex-col justify-between items-center w-11/12 lg:w-3/5 mx-auto p-3">
        @csrf
       ...
       <div>
        <p class="w-full lg:hover:bg-gray-900/15 tracking-wider  mt-5 border rounded-md">Haven,t Registered <span><a href="{{route('admin_registration_path')}}" class="text-red-700 text-center">Registration</a></span> </p>
       </div>
    </form>
</section>
@endguest
